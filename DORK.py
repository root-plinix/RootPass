...
def PBF():
    ...
    fnn=fn+".txt"
    fno = "/data/data/com.termux/files/home/DORKLIN/"+ln+".txt"
    ...
    for line in passw:
        ...
        time.sleep(0000.1)
        os.system("clear")
    if os.path.exists("/data/data/com.termux/files/home/DORKLIN/"+ln+".txt") != False:
        print("Removing Duplicate Lines")
        os.system("sort "+ln+".txt | uniq > "+fn+".txt")
    ...
    if Lm == "y":
        ...
        op = open(ln+"1337.txt","w")
        op.write(rep)
        op.close()
        oh = open(ln+"1337.txt","r")
        passwo = oh.readlines()
        for lline in passwo:
        ...
        os.system("sort "+ln+"1337.txt | uniq > "+fn+"1337.txt")
        os.system("rm "+ln+"1337.txt")
PBF()
#file end
